...
namespace WebBibliotecaMVC.Controllers
{
    public class VentaDetallesController : Controller
    {
        ...
        public VentaDetallesController(BibliotecaContext context)
        {
            _context = context;
        }
        ...
        {
            var bibliotecaContext = _context.VentaDetalles.Include(v => v.IdProductoNavigation).Include(v => v.IdVentaNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BibliotecaContext.VentaDetalles'  is null.");
            }
            var ventaDetalle = await _context.VentaDetalles.FindAsync(id);
            if (ventaDetalle != null)
            {
