...
namespace WebBibliotecaMVC.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string buscar)
        {
            ...
            {
                empleados = empleados.Where(x => x.Estado != -1 && x.Nombre!.Contains(buscar));
            }
        ...
        public async Task<IActionResult> Create([Bind("IdEmpleado,Nombre,Apellidos,Telefono,Cargo,Salario")] Empleado empleado)
        {
